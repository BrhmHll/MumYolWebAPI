...
namespace Core.Utilities.Security.JWT
{
	public class JwtHelper : ITokenHelper
    {
        ...
        public JwtSecurityToken CreateJwtSecurityToken(TokenOptions tokenOptions, User panelUser,
        ...
        private IEnumerable<Claim> SetClaims(User panelUser, List<OperationClaim> operationClaims)
        {
            ...
            claims.AddPhone(panelUser.PhoneNumber);
